...
def test_scramble():
    ...
    random.seed(1)
    assert scramble("a") == ""
    assert scramble("ab") == "B"
    assert scramble("abc") == "BC"
    assert scramble("abcd") == "BCD"
    assert scramble("abcde") == "BCD"
    assert scramble("abcdef") == "BDCF"
    assert scramble("abcde'f") == "BDC'F"
    assert scramble("Good Night") == "GHNDGT"
    assert scramble("Apple") == "PPL"
